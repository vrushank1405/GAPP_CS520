...
<body>
		...
		<div class="row-fluid">
			...
			<div id="content" class="span10" style="margin-bottom: 27%;">
				...
				<ul class="breadcrumb">
					...
					<li><!-- <i class="icon-edit"></i> --> <a href="#">Edit Department</a></li>
				</ul>
				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2>
								<i class="halflings-icon edit"></i><span class="break"></span>Department
							</h2>
							<div class="box-icon">
						...
						<div class="box-content">
							<form:form modelAttribute="dept" class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input path="departmentName" class="span6 typeahead"
											 />
										<br />
									</div>
								</div>
	...
	<div class="modal hide fade" id="myModal">
		...
		<div class="modal-body">
			...
			<h2 class="label label-success">Department Updated Successfully.
			</h2>
