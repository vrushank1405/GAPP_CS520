...
<title>GAPP - Additional Info</title>
</head>
<body>
	<!-- start: Header -->
	<div class="navbar">
		...
		<div class="row-fluid">
			...
			<div id="content" class="span10" style="margin-bottom: 27%;">
				...
				<ul class="breadcrumb">
					...
					<li>
						<!-- <i class="icon-edit"></i> --> <a href="#">Add Addiitonal
							Requirements</a>
					</li>
				</ul>
				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2>
								<i class="halflings-icon edit"></i><span class="break"></span>Additional Info
							</h2>
							<div class="box-icon">
						...
						<div class="box-content">
							<form action="/gapp/department/addAdditionalInfo.html"
								...
								<div class="control-group">
								<label class="control-label" for="selectError3">Required</label>
									<div class="controls">
										<select id="selectError3" name="required">
	...
	<div class="modal hide fade" id="myModal">
		...
		<div class="modal-body">
			...
			<h2 class="label label-success">Additional Info added successfully.</h2>

		</div>
		<div class="modal-footer">
			<a href="../department/viewAdditionalInfo.html"
