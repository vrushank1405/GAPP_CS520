		...
		<div class="row-fluid">
			...
			<div id="content" class="span10" style="margin-bottom: 27%;">
				...
				<ul class="breadcrumb">
					...
					<li>
						<!-- <i class="icon-edit"></i> --> <a href="#">Additional Info</a>
					</li>
				</ul>
				
				<div style="margin-bottom: 10px; text-align: right;">
					<a href="../department/addAdditionalInfo.html" title=""
						data-rel="tooltip" class="btn btn-warning"
						data-original-title="Add Additional Info">Add Additional Info</a>
				</div>
				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							...
							<form action="/gapp/department/viewAdditionalInfo.html"
						...
						<div class="box-content">
							...
							<c:if test="${fn:length(additionalInfo) gt 0}">
								<table
									...
									<tbody>
										<c:forEach items="${additionalInfo}" var="row">
											<tr>
												<td class="center">${row.name}</td>
												<td class="center">${row.dept.departmentName}</td>
												<td class="center">${row.fieldType}</td>
												<c:choose>
													<c:when test="${row.required eq 'true'}">
												...
												<td class="center"><a class="btn btn-danger"
													href="../department/deleteAdditionalInfo.html?ID=${row.additionalInfoId }"
