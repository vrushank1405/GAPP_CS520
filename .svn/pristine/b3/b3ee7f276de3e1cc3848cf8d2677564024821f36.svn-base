...
<!-- start: Header -->
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<a class="btn btn-navbar" data-toggle="collapse"
					...
					class="icon-bar"></span>
				</a> <a class="brand" href="#"><span>GAPP</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="../user/student.html"><i class="icon-bar-chart"></i><span
 ...
 -->							</ul></li>
			...
			<!-- start: Content -->
			<div id="content" class="span10" style="margin-bottom: 34%;">
				...
				<div class="row-fluid" style="height: 100%">
					...
					<a href="../student/viewStudentApplication.html"
						class="quick-button metro yellow span2">
						<p style="text-align: center;">
						<h2>View Application</h2>
						</p>
					</a>  <a href="../student/addStudentApplication.html"
						class="quick-button metro red span2">
						<p style="text-align: center;">
						<h2>Add Application</h2>
						</p>
					</a> <!--<a href="../department/viewDepartmentProgram.html"
						class="quick-button metro blue span2">
						<p style="text-align: center;">
						<h2>View Program</h2>
						</p>
					</a> <a href="../department/addDepartmentProgram.html" class="quick-button metro green span2">
					<p style="text-align: center;">
						<h2>Add Program</h2>
						</p>
					</a> <a href="../department/viewAdditionalInfo.html" class="quick-button metro pink span2"> 
					<p style="text-align: center;">
						<h2>View Additional Info</h2>
						</p>
					</a> <a href="../department/addAdditionalInfo.html" class="quick-button metro black span2">
					<p style="text-align: center;">
